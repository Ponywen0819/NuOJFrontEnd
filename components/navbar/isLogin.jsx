...
export const IsLoginInterface = () =>{
    ...
    if(!profile)
        return <Spinner size={'lg'} color='gray.200'/>
    ...
    return(
        <Menu>
            ...
            <MenuList>
                ...
                <MenuItem as={MenuLink} href={`/profile/${handle}`}>個人頁面</MenuItem>
                {isAdmin && <MenuItem as={MenuLink} href={`/admin/problem/list`}>管理員頁面</MenuItem>}
                <MenuDivider/>
