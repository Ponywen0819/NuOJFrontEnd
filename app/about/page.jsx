  ...
  return (
    <div className={"bg-cover flex items-center bg-orange-200"}>
      <div className="text-center p-5 bg-white rounded-xl mx-auto">
        <div className="py-8">
          <Link href="/">
            <img className="w-[8rem] mx-auto" src={logo_min.src} />
          </Link>
          <p className="text-4xl underline font-thin font-serif p-5">
            {" "}
          ...
          {profiles.map((profile, profile_i) => (
            <div className="profile-container" key={profile_i}>
              ...
              <div className="py-5">
                ...
                <div className="py-5">
                  {profile.dutys.map((duty, duty_i) => (
                    <p
                      className="text-base"
                      key={profile_i.toString() + duty_i.toString()}
                    >
                      {" "}
                      {duty}{" "}
                    </p>
